...
Verze 1.0.0rc2 je kandidát na vydání; produkční přijetí vyžaduje ověření v cílovém prostředí. Podrobné funkce, omezení, provoz a testy popisuje [README.md](../README.md). Nejde o náhradu poštovní brány ani ověřenou ochranu před všemi phishingovými útoky.

## Vývoj a rozšiřování

Začněte v [návodu pro vývojáře](DEVELOPMENT.md) a [AGENTS.md](../AGENTS.md). Přehled změn obsahuje [CHANGELOG.md](../CHANGELOG.md).
...
[Souhrn funkčnosti a ověření verze](RELEASE-1.0.md).
...
Podrobný postup a příklady obsahuje [konfigurace datových zdrojů](DATA-SOURCES.md). Přesnost jazykového rozhodování na zvoleném modelu lze ověřit příkazem `python -m evaluation.semantic_eval`; používá skutečné připojení k AI.
